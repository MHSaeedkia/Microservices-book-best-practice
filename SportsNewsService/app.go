...
func (a *App) initializeRoutes() {
	a.Router.GET("/sports/news/:news_id", a.get_single_news)
	a.Router.GET("/sports/news/all/:num_page/:limit", a.get_all_news)
	a.Router.POST("/sports/news", a.add_news)
	a.Router.GET("/sports/news/:news_id/publish/", a.publish_news)
	a.Router.PUT("/sports/news", a.update_news)
	a.Router.DELETE("/sports/news/:news_id", a.delete_news)
	a.Router.DELETE("/sports/news/all", a.delete_all_news)
}
